...
# String formatting
# %c for character, %s for string, %d for integer, %.5f upto 5 decimal places
...
string = "oH \"HelLo WElcoME To PythoN\". \nhow R U"
...
class Dog(Animal):
    ...
    def toString(self):
        return "{} is {} cm tall and {} kilograms and says {}. " \
               "His owner is {}".format(self.get_name(), self.get_height(),
...
print(spot.toString())
# Spot is 53 cm tall and 27 kilograms and says Ruff. His owner is Vaishnavi
